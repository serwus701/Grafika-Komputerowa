...
def render(time):
    ...
    if left_mouse_button_pressed:
        ...
        fi += delta_y * piy2angle
    
    elif right_mouse_button_pressed:
        if scale + delta_x * pix2scale < 0:
            scale = 0
        else:
    ...
    if mode == 1:
        ...
        viewer[0] = camera_scale * cos(theta * (pi / 180)) * cos(fi * (pi / 180))
        viewer[1] = camera_scale * sin(fi * (pi / 180))
        viewer[2] = camera_scale * sin(theta * (pi / 180)) * cos(fi * (pi / 180))
